...
namespace MonkeCosmetics.UI
{
	public class SelectionManager : ISelectionManager
	{
		...
		void CreateEnableButton()
		{
			...
			if (template == null)
			{
				Debug.LogError("MonkeCosmetics: Could not find enable button template");
				return;
			}
		...
		public void Enable()
		{
			...
			{
				Debug.LogError($"MonkeCosmetics: Failed to create direction buttons: {e}");
			}
			...
			{
				Debug.LogError($"MonkeCosmetics: Failed to show mirror: {e}");
			}
