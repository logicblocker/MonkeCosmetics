...
using MonkeCosmetics.HarmonyPatches;
using MonkeCosmetics.UI;
...
{
    [BepInPlugin("org.logicblocker.gorillatag.monkecosmetics", "Monke Cosmetics", "3.0.2")]
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        void Start()
        {
            ...
            MonkeCosmeticsPatches.ApplyHarmonyPatches();
		}
