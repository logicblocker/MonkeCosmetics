...
This mod also depends on Newtonsoft.Json, so go to my latest [Newtonsoft.Json release](https://github.com/logicblocker/Newtonsoft.Json/releases/latest) and follow the instructions there.

It also depends on Utilla, so install the latest [Utilla release](https://github.com/logicblocker/Utilla/releases/latest) as well

Next, go to the [latest release of this mod](https://github.com/logicblocker/MonkeCosmetics/releases/latest) and extract it directly into your game's folder. Make sure it's extracted directly into your game's folder and not into a subfolder!
...
Monke Cosmetics currently comes with an in-game mirror that allows you to select your hat and material.

If you'd like to change one of the options not available ingame or manually change what cosmetics you have selected, you can edit the config found in `Gorilla Tag/BepInEx/config/MonkeCosmetics.cfg` (The game must be run *at least once* after installing the mod for this file to be generated)
...
# What material to use from the BepInEx/plugins/MonkeCosmetics/Materials folder.
# Valid Options: Default/Camo/Gold/Matrix/Rainbow/Unity Default Material
SelectedMaterial = Rainbow

# What material to use from the BepInEx/plugins/MonkeCosmetics/Materials folder for tagged/infected players.
# Valid Options: Default/Camo/Gold/Matrix/Rainbow/Unity Default Material
SelectedInfectedMaterial = Default

# What hat to use from the BepInEx/plugins/MonkeCosmetics/Hats folder. Use Default for none
...
If you'd like to create Materials or Hats, the unity project can be found here: https://github.com/logicblocker/MonkeCosmeticsUnityProject
